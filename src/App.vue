  ...
  <div>
    ...
    <template slot="brand">
      <b-navbar-item tag="router-link" :to="{ path: '/' }">
        <svg height="22" width="112" viewBox="0 0 111.5 22" class="aj">
          <path
    ...
    <template slot="end">
      <b-navbar-item tag="div">
        <div class="buttons">
          <b-button tag="router-link" :to="{ path: '/edit-post' }" class="button is-primary" v-if="this.$store.state.user.role === 'writer'">
